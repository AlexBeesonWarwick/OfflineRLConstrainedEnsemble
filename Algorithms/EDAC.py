...
'''
Original EDAC code - https://github.com/snu-mllab/EDAC
Vectorised Linear code and _critic_diversity_loss - https://github.com/tinkoff-ai/CORL/blob/main/algorithms/edac.py
'''
